  ...
  return (
    <>
      ...
      <motion.button
        ...
        onClick={handleClick}
        className="fixed bottom-4 left-4 md:bottom-8 md:left-8 z-[9998] w-16 h-16 rounded-full flex items-center justify-center transition-transform hover:scale-110 active:scale-95"
        style={{
