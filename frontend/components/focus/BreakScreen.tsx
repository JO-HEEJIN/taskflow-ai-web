        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                onClick={onTakeBreak}
                className="group relative flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold rounded-2xl transition-all transform hover:scale-105 active:scale-95 overflow-hidden"
                style={{
              ...
              >
                ...
                <span className="text-white">Take a 5-min Break</span>
              ...
              <button
                onClick={onContinue}
                className="group flex items-center justify-center gap-3 px-8 py-4 text-lg font-medium text-white rounded-2xl transition-all hover:bg-white/10 border-2 border-white/30 hover:border-white/50"
              >
